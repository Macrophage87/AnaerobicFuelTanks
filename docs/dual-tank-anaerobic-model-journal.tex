...
budgets a data field 32~bytes of developer fields per message type, so the per-system consumption
and depleted totals are derived from the reserve streams ($\max(0, -\Delta R)/\Delta t$ for the
