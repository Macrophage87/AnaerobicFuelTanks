...
def _():
    ...
    # In this repository the Connect IQ project lives under connectiq/, so the
    # default root is connectiq/source, not source.
    with tempfile.TemporaryDirectory() as td:
        root = os.path.join(td, "connectiq", "source")
        os.makedirs(root)
